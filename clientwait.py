...
class TriviaClientWait(tk.Frame):
    def __init__(self, parent, server_address):
        ...
        threading.Thread(target=listenServer(server_address, self.show_game, self.server_listbox), daemon=True).start()  # Starte den Thread für die Serverkommunikation
